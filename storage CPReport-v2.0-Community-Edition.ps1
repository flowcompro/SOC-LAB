...
#-------------------------CHANGE THESE VALUES--------------------------------
$SMTPServer = "10.192.30.20"
$vCenterServerName = "10.192.30.55" 
$ToAddress = "kevin.f.flowers@contoso01.com", "destinationadress2@company.com", "destinationadress3@company.com"
#-----------------------------------------------------------------------------
